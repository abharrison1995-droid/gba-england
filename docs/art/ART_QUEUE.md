...
Last verified against: 65f23ea; the HUD-icon row added 2026-08-18; band 6 delivery route
                       ...
                       the same day; band 14 (arena surfaces) requested 2026-08-25
...
Requested 2026-08-25, nothing delivered. Same rules as Band 13 — **not sprites**, no
...
| File | Shape | Feeds |
|---|---|---|
| `arena_floor_red_gold_tile` | 4 x 4 m, tiles **both** axes | `mat_arena_regal_floor` at 8 x 8 |
| `arena_wall_marble_gold_strip` | 4 m wide x 4 m tall, tiles **left-right only** | `mat_arena_regal_wall` at 8 x 1 |
