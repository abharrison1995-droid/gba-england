...
Last verified against: 65f23ea; the HUD-icon row added 2026-08-18; band 6 delivery route
                       ...
                       (chunk ground textures) requested 2026-08-25, nothing delivered
...
| File | Material | Chunks | Covers |
|---|---|---|---|
| `grass_moor_dark_tile` | `Ground_MoorDark` | The Peaks, Knob Moor | 2.75 m, tiles both axes |
| `sand_scorched_tile` | `Ground_ScorchedSand` | Barren Lands | 2.75 m, tiles both axes |
| `rock_grey_harsh_tile` | `Ground_RockyGrey` | both Commie Slums | 2.75 m, tiles both axes |
| `track_dirt_strip` | `Track_Dirt` | The Peaks, Knob Moor | 10 x 10 m, **tiles along one axis only** |
