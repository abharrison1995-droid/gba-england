...
public static class ChunkArtMerge
{
    ...
    [MenuItem("Tools/World/Merge Selected Into Home London Prefab")]
    public static void MergeSelected()
    {
        ...
        Debug.Log($"Merged {selection.Length} object(s) into {HomePrefabPath} and disabled the scene copies. " +
                  ...
                  "Re-run Tools/World/Bake Navigation Mesh if props should block walking.");
    }

    [MenuItem("Tools/Repair/Fix Missing Materials In Chunk Prefabs")]
    public static void FixMissingMaterials()
    {
        ...
        {
            Debug.LogError("No placeholder materials found in Assets/Art/Placeholders — run Tools/Danger Zone/Generate Placeholder Art first.");
            return;
        }
