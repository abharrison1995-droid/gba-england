...
/// NavMesh afterward (Tools > GBA > World > Bake Navigation Mesh) so enemy
/// pathing actually routes around the new solid geometry too.
/// </summary>
public static class AddCollisionTool
{
    [MenuItem("Tools/GBA/World/Add Collision To Selection")]
    public static void Run()
    {
        ...
        Debug.Log($"AddCollisionTool: added BoxCollider + EnvironmentBlocker to {added} object(s). " +
                  "Now re-bake this chunk's NavMesh (Tools > GBA > World > Bake Navigation Mesh) " +
