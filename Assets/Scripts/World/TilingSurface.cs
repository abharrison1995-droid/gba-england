...
namespace ExiledAlvaston.World
{
    ...
    public class TilingSurface : MonoBehaviour
    {
        ...
        public void Apply()
        {
            ...
            // Plane spans X and Z with a degenerate Y. Taking the first two non-degenerate axes in
            // X, Y, Z order picks (X,Y) for the Quad and (X,Z) for the Plane, which is the order
            // their UVs run in both cases.
